...
- main.py: 717 → 96 строк
- Создано 11 новых файлов
- Все тесты: 4/4 PASSED
- Отчёт: SPRINT_1.1_COMPLETE.md

**Sprint 1.2: Убрать глобальные синглтоны** ← **СЛЕДУЮЩИЙ**
- [x] Создать api/dependencies.py (частично выполнено)
- [ ] Реализовать Depends для ElasticsearchClient
- [ ] Реализовать Depends для Services
- [ ] Убрать глобальные переменные
- [ ] Обновить все endpoints для использования Depends
- [ ] Обновить tests с mock'ами
